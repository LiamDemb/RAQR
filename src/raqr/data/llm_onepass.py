...
RULE_ID = "LLM_ONEPASS_V1"

_EXTRACT_ONEPASS_TOOL = {
    "type": "function",
    "function": {
        ...
        if msg and msg.tool_calls:
            for tc in msg.tool_calls:
                ...
                try:
                    ...
                    logger.warning("Failed to parse onepass tool args: %s", e)

        return _post_process_onepass(raw_entities, raw_triples, text, chunk_id)


def build_onepass_chat_request(
    prompt: str,
...
def build_onepass_batch_line(custom_id: str, body: Dict[str, Any]) -> Dict[str, Any]:
